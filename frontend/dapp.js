...
const contractAddress = "0x5b861f22c732ca20ca8E307D9d6F811529b13974";
...
const dApp = {
  ...
  registerArt: async function() {
    ...
    const startingBid = $("#dapp-starting-bid").val();
    ...
    if (!pinata_api_key || !pinata_secret_api_key || !name || !image|| !startingBid) {
